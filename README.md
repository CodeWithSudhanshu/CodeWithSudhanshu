<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:4F46E5,100:06B6D4&height=250&section=header&text=Sudhanshu%Sharma&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=38" width="100%"/>
</p>
...
|------------|----------------|----------|
| **[🚀 JobFlow — Career Command Center](https://github.com/CodeWithSudhanshu/jobFlow)** | Designed and developed a full-stack career management platform that centralizes job applications, application analytics, and resume analysis. Implemented **JWT-based authentication**, complete application CRUD, pipeline analytics, salary insights, and **ATS resume scoring**, with the application deployed in production using Vercel and Render. | `React` `Vite` `FastAPI` `Python` `PostgreSQL` `JWT` |
